...
module id(
    ...
    assign inst_sll=op_d[0]&&op1_d[0]&&func_d[6'b0];
    assign inst_srl=op_d[0]&&op1_d[0]&&func_d[2];
    assign inst_sra=op_d[0]&&op1_d[0]&&func_d[3];
    ...
    assign inst_op={
                        ...
                        inst_sra,
                        inst_lui};
    encoder_14_4 enc(inst_op,aluop_o);
    assign reg1_read_o=(rst==1)?0:
                        !(inst_sll||
                         inst_srl||
                         inst_sra||
                         inst_lui);
    ...
    wire[31:0] imm;
    assign imm=(rst==1)?0:
               (inst_lui?{inst_i[15:0],16'b0}:
                         {27'b0,inst_i[10:6]});
    assign reg1_o=(rst==1)?0:
                  (reg1_read_o?reg1_data_i:
                               imm);
    assign reg2_o=(rst==1)?0:
