...
HD_PWD='D:/CODE/computer_organization/DigitalWatch/DigitalWatch/DigitalWatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalWatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalWatch.tcl -notrace
