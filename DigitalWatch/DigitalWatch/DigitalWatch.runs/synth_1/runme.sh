...
HD_PWD='D:/CODE/computer_organization/DigitalWatch/DigitalWatch/DigitalWatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalWatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalWatch.tcl
